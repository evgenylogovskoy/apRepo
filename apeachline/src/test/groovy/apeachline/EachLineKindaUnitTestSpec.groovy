...
class EachLineKindaUnitTestSpec extends Specification {
	...
	@TestRailTest(testCaseId =  "108343", testCaseName =  "Some title 12")
...
//			def multiLineString = new File("src/test/resources/multilineFile.txt")
	...
	@TestRailTest(testCaseId =  "108344", testCaseName =  "Some title 23")
	...
	@TestRailTest(testCaseId =  "108345", testCaseName =  "Some title 32")
	...
	@TestRailTest(testCaseId =  "108346", testCaseName =  "Some title 43")
